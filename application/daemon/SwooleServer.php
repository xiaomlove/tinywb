...
class SwooleServer
{
    ...
    {
        echo __FUNCTION__ . '*******************************************';
        echo "task_id: $task_id, from_id: $from_id, data: $data\n";
        sleep(1);
        $serv->finish($serv, 2, 3);
    }

    public function onFinish($param1, $param2, $param3)
    {
        echo __FUNCTION__ . 'ssssssssssssssssssssssssssssssssssssssssss';
        print_r($param1);
        echo "\n";
    }
